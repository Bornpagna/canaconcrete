...
public function add($data=null) {
		...
		$pu_code->setAttribs(array('class'=>'validate[required] form-control select2me','placeholder'=>'Select Purchase No','onChange'=>'getVendor();getItem()'));
		...
		$vendor->setAttribs(array('class'=>'validate[required] form-control select2me','placeholder'=>'Select Purchase No'));
		...
		$totalAmountElement = new Zend_Form_Element_Hidden('totalAmoun_after');
    	$totalAmountElement->setAttribs(array('readonly'=>'readonly','style'=>'text-align:right',"class"=>"form-control"
    	));
    	$this->addElement($totalAmountElement);
